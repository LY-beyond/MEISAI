...
def load_analysis_results():
    ...
    # 加载特征重要性数据
    judge_importance = pd.read_csv('judge_feature_importance.csv')
    fan_importance = pd.read_csv('fan_feature_importance.csv')
    
    # 加载争议案例
    controversial_cases = pd.read_csv('controversial_cases.csv')
    
    # 加载交互效应数据
    try:
        judge_interactions = pd.read_csv('judge_interactions.csv')
        fan_interactions = pd.read_csv('fan_interactions.csv')
    except:
